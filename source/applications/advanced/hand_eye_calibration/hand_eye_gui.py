...
from zividsamples.buttons_widget import CameraButtonsWidget
from zividsamples.camera_selection import select_camera
from zividsamples.cv2_handler import CV2Handler
from zividsamples.hand_eye_calibration_gui import HandEyeCalibrationGUI
from zividsamples.hand_eye_configuration import CalibrationObject, select_hand_eye_configuration
from zividsamples.hand_eye_verification_gui import HandEyeVerificationGUI
from zividsamples.live_2d_widget import Live2DWidget
from zividsamples.marker_widget import MarkerConfiguration, select_marker_configuration
from zividsamples.qt_application import ZividQtApplication
from zividsamples.robot_control import RobotTarget
from zividsamples.robot_control_widget import RobotControlWidget
from zividsamples.rotation_format_configuration import RotationInformation, select_rotation_format
from zividsamples.settings_selector import Settings, select_settings_for_hand_eye
from zividsamples.stitch_gui import StitchGUI
from zividsamples.touch_gui import TouchGUI
from zividsamples.transformation_matrix import TransformationMatrix
from zividsamples.tutorial_widget import TutorialWidget
...
class HandEyeGUI(QMainWindow):
    ...
    def on_calibration_finished(self, transformation_matrix: TransformationMatrix):
    ...
    def on_instructions_updated(self):
    ...
    def on_touch_pose_updated(self, touch_target: TransformationMatrix):
    ...
    def on_load_from_data_directory_action_triggered(self):
    ...
    def on_save_to_data_directory_action_triggered(self):
        data_directory = Path(
    ...
    def on_select_hand_eye_settings_action_triggered(self):
        self.settings = select_settings_for_hand_eye(self.camera)

    def on_hand_eye_action_triggered(self, action):
    ...
    def on_calibration_object_action_triggered(self, calibration_object: CalibrationObject):
        self.hand_eye_configuration.calibration_object = calibration_object
        self.hand_eye_calibration_gui.hand_eye_configuration_update(self.hand_eye_configuration)
        self.hand_eye_verification_gui.hand_eye_configuration_update(self.hand_eye_configuration)

    def on_select_marker_configuration(self):
    ...
    def on_select_rotation_format(self):
    ...
    def on_toggle_advanced_view_action_triggered(self, checked, _=None):
        self.hand_eye_calibration_gui.toggle_advanced_view(checked)
        self.hand_eye_verification_gui.toggle_advanced_view(checked)

    def on_toggle_use_robot_action_triggered(self, checked, _=None):
...
def _main() -> None:
    ...
    sys.exit(qtApp.run(HandEyeGUI(), "Hand-Eye GUI"))
