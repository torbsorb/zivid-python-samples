...
from zividsamples.capture_at_pose_selection_widget import CaptureAtPose, CaptureAtPoseSelectionWidget
...
if sys.version_info < (3, 12):
    from zividsamples.pointcloud_visualizer import Open3DVisualizerWidget
